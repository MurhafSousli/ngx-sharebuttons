...
module.exports = {
  ...
  meta: [
    ...
    { name: 'title', content: 'Angular2 Share Buttons' },
    { name: 'description', content: 'Simple, lightweight, customizable share buttons' },


    { property: 'og:site_name', content: 'Angular2 Share Buttons'},
    { property: 'og:title', content: 'Angular2 Share Buttons' },
    { property: 'og:description', content: 'Simple, lightweight, customizable share buttons' },
    { property: 'og:url', content:  'https://murhafsousli.github.io/ng2-sharebuttons' },
    { property: 'og:image', content: 'https://murhafsousli.github.io/ng2-sharebuttons/assets/img/cover.png' },
