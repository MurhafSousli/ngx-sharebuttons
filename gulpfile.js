...
gulp.task('inline-templates', ['clean:dist', 'styles', 'ts-lint'], function (cb) {
    var defaults = {
        base: '/src',
        target: 'es5',
...
// Testing Tasks
gulp.task('test', ['clean:coverage', 'compile-ts'], function (cb) {
...
gulp.task('npm', ['compile-ts', 'test'], function (cb) {
